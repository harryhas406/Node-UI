...
USER_AGENT_STRING = 'Mozilla/5.0 ({} {}-bit) phishing/{}'.format(sys.platform, sys.maxsize.bit_length() + 1, __version__)
...
class Fuzzer():
	glyphs_idn_by_tld = {
		...
		**dict.fromkeys(['eu', 'de', 'pl'], {
			'a': ('Ã¡', 'Ã ', 'Äƒ', 'Ã¢', 'Ã¥', 'Ã¤', 'Ã£', 'Ä…', 'Ä'),
			'c': ('Ä‡', 'Ä‰', 'Ä', 'Ä‹', 'Ã§'),
			'd': ('Ä', 'Ä‘'),
			'e': ('Ã©', 'Ã¨', 'Ä•', 'Ãª', 'Ä›', 'Ã«', 'Ä—', 'Ä™', 'Ä“'),
			'g': ('ÄŸ', 'Ä', 'Ä¡', 'Ä£'),
			'h': ('Ä¥', 'Ä§'),
			'i': ('Ã­', 'Ã¬', 'Ä­', 'Ã®', 'Ã¯', 'Ä©', 'Ä¯', 'Ä«'),
			'j': ('Äµ',),
			...
			'l': ('Äº', 'Ä¾', 'Ä¼', 'Å‚'),
			'n': ('Å„', 'Åˆ', 'Ã±', 'Å†'),
			'o': ('Ã³', 'Ã²', 'Å', 'Ã´', 'Ã¶', 'Å‘', 'Ãµ', 'Ã¸', 'Å'),
			'r': ('Å•', 'Å™', 'Å—'),
			's': ('Å›', 'Å', 'Å¡', 'ÅŸ'),
			't': ('Å¥', 'Å£', 'Å§'),
			'u': ('Ãº', 'Ã¹', 'Å­', 'Ã»', 'Å¯', 'Ã¼', 'Å±', 'Å©', 'Å³', 'Å«'),
			'w': ('Åµ',),
			'y': ('Ã½', 'Å·', 'Ã¿'),
			'z': ('Åº', 'Å¾', 'Å¼'),
			'ae': ('Ã¦',),
	...
	glyphs_unicode = {
		...
		'3': ('Ê’',),
		'5': ('Æ½',),
		'a': ('áº¡', 'Äƒ', 'È§', 'É‘', 'Ã¥', 'Ä…', 'Ã¢', 'ÇŽ', 'Ã¡', 'É™', 'Ã¤', 'Ã£', 'Ä', 'Ã '),
		'b': ('á¸ƒ', 'á¸…', 'Æ…', 'Ê™', 'á¸‡', 'É“'),
		'c': ('Ä', 'á´„', 'Ä‹', 'Ã§', 'Ä‡', 'Ä‰', 'Æˆ'),
		'd': ('Ä', 'á¸', 'á¸‹', 'É–', 'á¸', 'É—', 'á¸“', 'á¸‘', 'Ä‘'),
		'e': ('Ãª', 'áº¹', 'Ä™', 'Ã¨', 'á¸›', 'Ä›', 'É‡', 'Ä—', 'Ä•', 'Ã©', 'Ã«', 'Ä“', 'È©'),
		'f': ('á¸Ÿ', 'Æ’'),
		'g': ('Ç§', 'Ä¡', 'Çµ', 'ÄŸ', 'É¡', 'Ç¥', 'Ä', 'Ä£', 'É¢'),
		'h': ('ÈŸ', 'á¸«', 'á¸©', 'á¸£', 'É¦', 'á¸¥', 'á¸§', 'Ä§', 'áº–', 'â±¨', 'Ä¥'),
		'i': ('É©', 'Ç', 'Ã­', 'Éª', 'á»‰', 'È‹', 'É¨', 'Ã¯', 'Ä«', 'Ä©', 'á»‹', 'Ã®', 'Ä±', 'Ä­', 'Ä¯', 'Ã¬'),
		'j': ('Ç°', 'Äµ', 'Ê', 'É‰'),
		'k': ('Ä¸', 'Ç©', 'â±ª', 'á¸µ', 'Ä·', 'á´‹', 'á¸³'),
		'l': ('Äº', 'Å‚', 'É«', 'Ä¼', 'Ä¾'),
		'm': ('á´', 'á¹', 'á¸¿', 'á¹ƒ', 'É±'),
		'n': ('Å†', 'Ç¹', 'Å„', 'Åˆ', 'á¹…', 'á¹‰', 'á¹‡', 'êž‘', 'Ã±', 'Å‹'),
		'o': ('Ã¶', 'Ã³', 'È¯', 'á»', 'Ã´', 'á´', 'Å', 'Ã²', 'Å', 'Æ¡', 'Å‘', 'Ãµ', 'á»', 'Ã¸'),
		'p': ('á¹—', 'Æ¿', 'Æ¥', 'á¹•'),
		'q': ('Ê ',),
		'r': ('Ê€', 'È“', 'É', 'É¾', 'Å™', 'á¹›', 'É½', 'È‘', 'á¹™', 'Å—', 'Å•', 'É¼', 'á¹Ÿ'),
		's': ('á¹¡', 'È™', 'Å', 'êœ±', 'Ê‚', 'Å¡', 'Å›', 'á¹£', 'ÅŸ'),
		't': ('Å¥', 'Æ«', 'Å£', 'á¹­', 'á¹«', 'È›', 'Å§'),
		'u': ('á´œ', 'Å³', 'Å­', 'Å«', 'Å±', 'Ç”', 'È•', 'Æ°', 'Ã¹', 'Å¯', 'Ê‰', 'Ãº', 'È—', 'Ã¼', 'Ã»', 'Å©', 'á»¥'),
		'v': ('á¶Œ', 'á¹¿', 'á´ ', 'â±´', 'â±±', 'á¹½'),
		'w': ('á´¡', 'áº‡', 'áº…', 'áºƒ', 'áº˜', 'áº‰', 'â±³', 'Åµ', 'áº'),
		'x': ('áº‹', 'áº'),
		'y': ('Å·', 'Ã¿', 'Ê', 'áº', 'É', 'Æ´', 'È³', 'Ã½', 'á»¿', 'á»µ'),
		'z': ('Å¾', 'Æ¶', 'áº“', 'áº•', 'â±¬', 'á´¢', 'Å¼', 'Åº', 'Ê'),
		'ae': ('Ã¦',),
		'oe': ('Å“',),
	}
	...
	latin_to_cyrillic = {
		'a': 'Ð°', 'b': 'ÑŒ', 'c': 'Ñ', 'd': 'Ô', 'e': 'Ðµ', 'g': 'Ô', 'h': 'Ò»',
		'i': 'Ñ–', 'j': 'Ñ˜', 'k': 'Ðº', 'l': 'Ó', 'm': 'Ð¼', 'o': 'Ð¾', 'p': 'Ñ€',
		'q': 'Ô›', 's': 'Ñ•', 't': 'Ñ‚', 'v': 'Ñµ', 'w': 'Ô', 'x': 'Ñ…', 'y': 'Ñƒ',
	}
...
def run(**kwargs):
	...
	parser.add_argument('--version', action='version', version='phishing {}'.format(__version__), help=argparse.SUPPRESS)
